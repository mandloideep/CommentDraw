...
import com.CommentDraw.Backend.exception.InvalidOTPException;
...
class OtpServiceImplTest {
    ...
    private final String email = "user@commentdraw.com";
    private final String key = "delete_otp:user@commentdraw.com";
