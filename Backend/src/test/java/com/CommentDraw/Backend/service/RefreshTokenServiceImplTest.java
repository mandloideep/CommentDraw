...
import com.CommentDraw.Backend.exception.RefreshTokenExpiredException;
import com.CommentDraw.Backend.repository.RefreshTokenRepository;
...
class RefreshTokenServiceImplTest {
    ...
    void setUp() {
        sampleUser = new User();
        sampleUser.setId(1L);
        sampleUser.setEmail("user@commentdraw.com");
